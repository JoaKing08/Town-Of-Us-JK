            ...
            void Listener()
            {
                ...
                if (!toDie.Is(RoleEnum.Pestilence) && !toDie.Is(RoleEnum.Famine) && !toDie.Is(RoleEnum.War) && !toDie.Is(RoleEnum.Death))
                {
                    ...
                    else if (toDie.IsCooperator() && CustomGameOptions.BothCooperatorsDie)
                    {
                        ...
                        if (!cooperator.Is(RoleEnum.Pestilence) && !cooperator.Is(RoleEnum.Famine) && !cooperator.Is(RoleEnum.War) && !cooperator.Is(RoleEnum.Death)) ShowHideButtonsVigi.HideSingle(role, cooperator.PlayerId, false);
                    }
                    ...
                    else if (toDie.Is(RoleEnum.Godfather) && CustomGameOptions.MafiosoLifelink)
                    {
                        ...
                        if (mafioso != null && !mafioso.Data.IsDead && !mafioso.Data.Disconnected) ShowHideButtonsVigi.HideSingle(role, mafioso.PlayerId, false);
                    }
