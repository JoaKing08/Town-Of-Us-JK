...
namespace TownOfUs.CrewmateRoles.MedicMod
{
    ...
    public class StopKill
    {
        public static void BreakShield(byte medicId, byte playerId, bool flag)
        {
            ...
            {
                Coroutines.Start(Utils.FlashCoroutine(new Color(0f, 0.5f, 0f, 1f)));
                Role.GetRole(PlayerControl.LocalPlayer).Notification("Shielded Player Was Attacked!", 1000 * CustomGameOptions.NotificationDuration);
            }
            ...
            if (CustomGameOptions.NotificationShield == NotificationOptions.Everyone)
            {
                ...
                else Role.GetRole(PlayerControl.LocalPlayer).Notification("Shielded Player Was Attacked!", 1000 * CustomGameOptions.NotificationDuration);
            }
