...
namespace TownOfUs
{
    ...
    public static class VersionShowerUpdate
    {
        public static void Postfix(VersionShower __instance)
        {
            ...
            text.text += " - <color=#00FF00FF>TownOfUs v" + TownOfUs.VersionString + "</color>" + TownOfUs.VersionTag +", <color=#FFD000FF>JoaKing's addon v" + TownOfUs.ModesVersionString + "</color>";
