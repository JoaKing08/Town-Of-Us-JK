...
namespace TownOfUs.Roles.Horseman
{
    public class Berserker : Role
    {
        ...
        protected override void IntroPrefix(IntroCutscene._ShowTeam_d__36 __instance)
        {
            ...
            foreach (var player in PlayerControl.AllPlayerControls) if ((player.Is(Faction.NeutralApocalypse) || player.Is(ModifierEnum.ApocalypseAgent) || (player.Is(RoleEnum.Undercover) && Utils.UndercoverIsApocalypse())) && player != PlayerControl.LocalPlayer) apoTeam.Add(player);
        ...
        public void TurnWar()
        {
            ...
            if (CustomGameOptions.AnnounceWar) Coroutines.Start(Utils.FlashCoroutine(Patches.Colors.War));
            else if (Player == PlayerControl.LocalPlayer) Coroutines.Start(Utils.FlashCoroutine(Patches.Colors.War));
