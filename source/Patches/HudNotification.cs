    ...
    public class HudNotification
    {
        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            if (role.NotificationText == null)
            {
                ...
                role.NotificationText.transform.localPosition = new Vector3(role.NotificationText.transform.localPosition.x, role.NotificationText.transform.localPosition.y + 1.5f, role.NotificationText.transform.localPosition.z - 100f);
